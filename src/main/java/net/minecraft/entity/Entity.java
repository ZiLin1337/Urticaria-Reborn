...
import cn.hackedmc.urticaria.newevent.impl.motion.LavaEvent;
...
public abstract class Entity implements ICommandSender {
     ...
     */
    public transient Entity riddenByEntity;
    ...
    public double lastGroundX, lastGroundY, lastGroundZ, lastLastGroundX, lastLastGroundY, lastLastGroundZ;
    ...
    protected transient DataWatcher dataWatcher;
    ...
    protected transient BlockPos field_181016_an;
    protected transient Vec3 field_181017_ao;
    protected transient EnumFacing field_181018_ap;
     ...
     */
    private transient final CommandResultStats cmdResultStats;

    public Render<?> renderType;
    ...
    public util.time.StopWatch timer = new StopWatch();
    public util.time.StopWatch timerName = new StopWatch();
...
//        this.speeds.add(Math.sqrt((this.prevPosX - this.posX) * (this.prevPosX - this.posX) + (this.prevPosZ - this.posZ) * (this.prevPosZ - this.posZ)));
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (onGround) {
                lastLastGroundX = lastGroundX;
                lastLastGroundY = lastGroundY;
                lastLastGroundZ = lastGroundZ;
                lastGroundX = posX;
                lastGroundY = posY;
                lastGroundZ = posZ;
            }
