    ...
    public static void checkDisplaySettings() {
        ...
        if (i > 0) {
            ...
            if (!Minecraft.isRunningOnMac && getResourceManager() != null) {
                ...
                try {
                    inputstream = Config.class.getResourceAsStream("urticaria/icons/icons_16x16.png");
                    inputstream1 = Config.class.getResourceAsStream("urticaria/icons/icons_32x32.png");
