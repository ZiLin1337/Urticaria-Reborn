...
public class BlockPos extends Vec3i {
    ...
    public static Iterable<BlockPos.MutableBlockPos> getAllInBoxMutable(final BlockPos from, final BlockPos to) {
        final BlockPos blockpos = new BlockPos(Math.min(from.getX(), to.getX()), Math.min(from.getY(), to.getY()), Math.min(from.getZ(), to.getZ()));
        final BlockPos blockpos1 = new BlockPos(Math.max(from.getX(), to.getX()), Math.max(from.getY(), to.getY()), Math.max(from.getZ(), to.getZ()));
    ...
    public static final class MutableBlockPos extends BlockPos {
        ...
        public BlockPos.MutableBlockPos func_181079_c(final int p_181079_1_, final int p_181079_2_, final int p_181079_3_) {
            this.x = p_181079_1_;
            this.y = p_181079_2_;
            this.z = p_181079_3_;
            return this;
