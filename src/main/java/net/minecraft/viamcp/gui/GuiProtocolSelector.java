...
public class GuiProtocolSelector extends GuiScreen {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final int fixedHeight = ((5 + mc.fontRendererObj.FONT_HEIGHT) * 2) + 2;
        ...
        drawString(this.fontRendererObj, versionTitle, (width - this.fontRendererObj.width(versionTitle)) / 2, fixedHeight + mc.fontRendererObj.FONT_HEIGHT, -1);
        drawString(this.fontRendererObj, versionReleased, (width - this.fontRendererObj.width(versionReleased)) / 2, fixedHeight + mc.fontRendererObj.FONT_HEIGHT * 2, -1);
