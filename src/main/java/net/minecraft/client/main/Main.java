...
//        final OptionSpec<String> name = optionparser.accepts("loginName").withRequiredArg().defaultsTo("");
//        final OptionSpec<String> password = optionparser.accepts("loginPassword").withRequiredArg().defaultsTo("");
//        final OptionSpec<String> request = optionparser.accepts("requestText").withRequiredArg().defaultsTo("");
        ...
        final OptionSpec<File> optionspec3 = optionparser.accepts("assetsDir").withRequiredArg().ofType(File.class);
        ...
        final OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Player" + new Random().nextInt(999));
...
//        Fucker.loginUsername = optionset.valueOf(name);
//        Fucker.loginPassword = optionset.valueOf(password);
//        Fucker.requestText = optionset.valueOf(request);
