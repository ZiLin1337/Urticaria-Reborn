...
import cn.hackedmc.urticaria.module.impl.render.FreeLook;
...
import cn.hackedmc.urticaria.newevent.impl.other.*;
import cn.hackedmc.urticaria.ui.ingame.GuiIngameCache;
import cn.hackedmc.urticaria.ui.menu.impl.intro.IntroSequence;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    public final int splashIndex = new Random().nextInt(2) + 1;
...
//        Fucker.fuckThis();
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("urticaria/icons/icon_16x16.png"));
                inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("urticaria/icons/icon_32x32.png"));
    ...
    private void drawSplashScreen(final TextureManager textureManagerInstance) {
        ...
        RenderUtil.image(new ResourceLocation("urticaria/images/splash" + splashIndex + ".png"), 0, 0, sr.getScaledWidth(), sr.getScaledHeight());
    ...
    public void runTick() throws IOException {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (this.gameSettings.keyBindInventory.isPressed()) {
                final InventoryOpenEvent inventoryOpenEvent = new InventoryOpenEvent();
                Client.INSTANCE.getEventBus().handle(inventoryOpenEvent);
...
//            }
        ...
        if (this.thePlayer != null && this.thePlayer.ticksExisted % 4 == 0) GuiIngameCache.dirty = true;
        this.mcProfiler.endSection();
