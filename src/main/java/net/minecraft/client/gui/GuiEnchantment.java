...
public class GuiEnchantment extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mouseX, final int mouseY) {
        ...
        final float f2 = this.field_147076_A + (this.field_147080_z - this.field_147076_A) * partialTicks;
        ...
        for (int l = 0; l < 3; ++l) {
            ...
            zLevel = 0.0F;
            this.mc.getTextureManager().bindTexture(ENCHANTMENT_TABLE_GUI_TEXTURE);
            final int l1 = this.container.enchantLevels[l];
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            if (l1 == 0) {
                ...
                if ((k < l + 1 || this.mc.thePlayer.experienceLevel < l1) && !this.mc.thePlayer.capabilities.isCreativeMode) {
                    ...
                    final int j2 = mouseX - (i + 60);
                    final int k2 = mouseY - (j + 14 + 19 * l);
                ...
                fontrenderer.drawStringWithShadow(s1, (float) (j1 + 86 - fontrenderer.width(s1)), (float) (j + 16 + 19 * l + 7), i2);
            }
        }
    }
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0) {
                ...
                if (Enchantment.getEnchantmentById(l & 255) != null) {
                    final String s = Enchantment.getEnchantmentById(l & 255).getTranslatedName((l & 65280) >> 8);
