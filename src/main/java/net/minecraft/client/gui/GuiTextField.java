...
public class GuiTextField extends Gui {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            final int i1 = this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 2 : this.yPosition;
            int j1 = l;
            ...
            if (s.length() > 0) {
                ...
                j1 = this.fontRendererInstance.drawStringWithShadow(s1, (float) l, (float) i1 + 1, i);
            }
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = this.fontRendererInstance.drawStringWithShadow(s.substring(j), (float) j1, (float) i1 + 1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    this.fontRendererInstance.drawStringWithShadow("_", (float) k1, (float) i1 + 1, i);
                }
            }

            if (k != j) {
                final int l1 = l + this.fontRendererInstance.width(s.substring(0, k));
