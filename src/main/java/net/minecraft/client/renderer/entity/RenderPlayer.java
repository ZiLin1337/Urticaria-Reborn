...
import cn.hackedmc.urticaria.Client; // 添加 Client 导入
import cn.hackedmc.urticaria.module.impl.combat.KillAura;
import cn.hackedmc.urticaria.module.impl.render.Animations;
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer) {
        ...
        if (clientPlayer.isSpectator()) {
            ...
            if (itemstack == null) {
                ...
                // 修复：使用 Client.INSTANCE.getModuleManager().get(KillAura.class) 替代 KillAura.INSTANCE
                if (clientPlayer.getItemInUseCount() > 0 || (clientPlayer == InstanceAccess.mc.thePlayer && Client.INSTANCE.getModuleManager().get(KillAura.class).canRenderBlock())) {
    ...
    protected void renderOffsetLivingLabel(AbstractClientPlayer entityIn, double x, double y, double z, String str, float p_177069_9_, double p_177069_10_) {
        if (p_177069_10_ < 100.0D) {
            ...
            if (scoreobjective != null) {
                Score score = scoreboard.getValueFromObjective(entityIn.getNameClear(), scoreobjective);
