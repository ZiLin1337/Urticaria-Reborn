...
public class WorldRenderer {
    ...
    public void func_181674_a(final float p_181674_1_, final float p_181674_2_, final float p_181674_3_) {
        ...
        for (int l1 = 0; (l1 = bitset.nextClearBit(l1)) < ainteger.length; ++l1) {
            final int i1 = ainteger[l1].intValue();
        ...
        if (this.quadSprites != null) {
            ...
            for (int j2 = 0; j2 < ainteger.length; ++j2) {
                final int k2 = ainteger[j2].intValue();
    ...
    public void setVertexState(final WorldRenderer.State state) {
    ...
    public void putColorMultiplier(final float red, final float green, final float blue, final int p_178978_4_) {
        ...
        if (!this.needsUpdate) {
            ...
            if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
                final int k = (int) ((float) (j & 255) * red);
                final int l = (int) ((float) (j >> 8 & 255) * green);
                final int i1 = (int) ((float) (j >> 16 & 255) * blue);
                j = j & -16777216;
                j = j | i1 << 16 | l << 8 | k;

//                j = getColor(k, l, i1, 50);
            } else {
                final int j1 = (int) ((float) (j >> 24 & 255) * red);
                final int k1 = (int) ((float) (j >> 16 & 255) * green);
                final int l1 = (int) ((float) (j >> 8 & 255) * blue);
                j = j & 255;
                j = j | j1 << 24 | k1 << 16 | l1 << 8;

//                j = getColor(j1, k1, l1, 50);
            }
        }
    ...
    public void putColorMultiplierRgba(float p_putColorMultiplierRgba_1_, float p_putColorMultiplierRgba_2_, float p_putColorMultiplierRgba_3_, float p_putColorMultiplierRgba_4_, int p_putColorMultiplierRgba_5_) {
        ...
        if (!this.needsUpdate) {
            ...
            if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
                final int k = (int) ((float) (j & 255) * p_putColorMultiplierRgba_1_);
                final int l = (int) ((float) (j >> 8 & 255) * p_putColorMultiplierRgba_2_);
                final int i1 = (int) ((float) (j >> 16 & 255) * p_putColorMultiplierRgba_3_);
                final int j1 = (int) ((float) (j >> 24 & 255) * p_putColorMultiplierRgba_4_);


                j = j1 << 24 | i1 << 16 | l << 8 | k;
            } else {
                final int k1 = (int) ((float) (j >> 24 & 255) * p_putColorMultiplierRgba_1_);
                final int l1 = (int) ((float) (j >> 16 & 255) * p_putColorMultiplierRgba_2_);
                final int i2 = (int) ((float) (j >> 8 & 255) * p_putColorMultiplierRgba_3_);
                final int j2 = (int) ((float) (j & 255) * p_putColorMultiplierRgba_4_);
