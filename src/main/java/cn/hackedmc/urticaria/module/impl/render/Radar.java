...
public class Radar extends Module {
    ...
    private final ResourceLocation radarBeamResource = new ResourceLocation("urticaria/icons/radar/radarbeam.png");
    private final ResourceLocation radarDotResource = new ResourceLocation("urticaria/icons/radar/radardot.png");
    private final ResourceLocation radarScopeResource = new ResourceLocation("urticaria/icons/radar/radarscope.png");
