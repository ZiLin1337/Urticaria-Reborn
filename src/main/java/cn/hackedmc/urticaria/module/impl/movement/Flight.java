...
import cn.hackedmc.urticaria.module.impl.movement.flight.deprecated.ACRFlight;
import cn.hackedmc.urticaria.module.impl.movement.flight.deprecated.DamageFlight;
...
public class Flight extends Module {
    ...
    private final ModeValue mode = new ModeValue("Mode", this)
            ...
            .add(new GrimACVertical("GrimAC Vertical", this))
            ...
            .add(new HeypixelFlight("Heypixel", this))
