package cn.hackedmc.urticaria.util.chat;
...
public class ChatUtil implements InstanceAccess {
    ...
    public void displayIRC(final Object message, final Object... objects) {
        ...
        final String format = String.format(String.valueOf(message), objects);

        if (mc.thePlayer != null) {
            mc.thePlayer.addChatMessage(new ChatComponentText("§l[§bUrticaria§r§l] §r" + format));
        } else {
