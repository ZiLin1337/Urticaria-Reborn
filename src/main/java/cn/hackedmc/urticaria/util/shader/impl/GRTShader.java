...
public class GRTShader {

    private final RiseShaderProgram program = new RiseShaderProgram("lrgq.glsl", "vertex.vsh");
     ...
     */
    public void draw(float x, float y, float width, float height, float offset, float radius, Color firstColor, Color secondColor, boolean vertical) {
     ...
     * @param vertical    Whether the gradient is horizontal or vertical
     */
    public void draw(double x, double y, double width, double height, double offset, double radius, Color firstColor, Color secondColor, boolean vertical) {
        draw((float) x, (float) y, (float) width, (float) height, (float) offset, (float) radius, firstColor, secondColor, vertical);
    }
}
