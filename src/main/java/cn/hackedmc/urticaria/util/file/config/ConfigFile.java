package cn.hackedmc.urticaria.util.file.config;
 ...
 * @since 10/19/2021
 */
public class ConfigFile extends cn.hackedmc.urticaria.util.file.File {
    ...
    public boolean read() {
        ...
        try {
            ...
            Client.INSTANCE.noNotify = false;
            return false;
        }
