package cn.hackedmc.urticaria.util.localization;
...
public class Localization {
     ...
     * located in apotheosis/text
     */
    @SneakyThrows
    public static void populate() {
        for (Locale locale : Locale.values()) {
            ResourceLocation resourceLocation = new ResourceLocation("urticaria/text/" + locale.getFile() + ".properties");
