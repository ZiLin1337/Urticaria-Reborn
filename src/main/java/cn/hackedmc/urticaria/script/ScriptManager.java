package cn.hackedmc.urticaria.script;

import cn.hackedmc.urticaria.Client;
import cn.hackedmc.urticaria.script.api.*;
import cn.hackedmc.urticaria.script.util.ScriptClassFilter;
...
public final class ScriptManager implements InstanceAccess {
    ...
    public void init() {
        ...
        this.globalBindings = new SimpleBindings() {{
            ...
            this.put("urticaria", new RiseAPI());
